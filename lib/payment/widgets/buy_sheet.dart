...
import 'package:s2_international/utils/transaction_service.dart';
        ...
        home: Scaffold(
          ...
          body: Builder(
            builder: (context) => Center(
              ...
              children: [
                Container(
                  child: Image(image: AssetImage(logoblue)),
                ),
                Container(
                  child: Text(
                    'S2 International Calling Service',
                    style: TextStyle(
                      color: Colors.white,
                      fontSize: 28,
                    ),
                ...
                Container(
                  child: Text(
                    "Instantly gain special powers to call after purchasing our credit",
                    style: TextStyle(
                      color: Colors.white,
                      fontSize: 16,
                    ),
                ...
                Container(
                  ...
                  child: CookieButton(
                      text: "Purchase Credit", onPressed: _showOrderSheet),
                ),
              ],
            )),
          ),
